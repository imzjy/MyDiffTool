    ...
    function restore_last_editing() {
      ...
      $('#single_column_view').prop('checked', localStorage.getItem('single_column_view') === "true" || false);
    }
    ...
    function do_compare() {
      ...
      var unitedDiff = Diff.createPatch('', left, right, '', '', { context: 9999, ignoreCase: ignore_case });
